export const footer = {
  ...
  social: [
    {
      id: 1,
      path: 'https://www.facebook.com/mothernature/',
    ...
    {
      id: 2,
      path: 'https://twitter.com/mothernature',
    ...
    {
      id: 3,
      path: 'https://www.instagram.com/mothernature/',
    ...
    {
      id: 4,
      path: 'https://www.youtube.com/channel/mothernature',
